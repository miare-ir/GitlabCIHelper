...
const defaultCodexImageRepo = "ghcr.io/miare-ir/gitlab-ci-helper-runner"

// BuildVersion is injected at build time for release binaries.
// Example: -X gitlab_ci_helper/internal/setup.BuildVersion=v0.0.2
var BuildVersion = ""

func defaultCodexImage() string {
	version := strings.TrimSpace(BuildVersion)
	if version == "" {
		return defaultCodexImageRepo + ":v0"
	}
	return defaultCodexImageRepo + ":" + version
}
